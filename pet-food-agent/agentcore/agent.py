"""Pet Food Recommendation Agent using Bedrock AgentCore and Strands SDK."""
...
def get_ssm_parameter(parameter_name: str) -> str:
    ...
    Returns:
        Parameter value or raises exception if not found
    """
    try:
...
# System prompt with cached URLs
...
# Global conversation manager for session continuity
...
async def pet_food_agent_bedrock(payload):
    ...
    Args:
        payload: Request payload containing 'prompt' and 'userId' keys
    ...
    # Add trace attributes using OpenTelemetry
